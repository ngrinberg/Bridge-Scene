	...
	@Tags({"Command Token"})
public class CommandClass implements Wordterface {//implements both the general token class interface for the editable as well as an additional interface this is a long sentence.

		String editableInput;
		   String readOnlyInput;
			String edit;

			public CommandClass(String userInput)
			{
